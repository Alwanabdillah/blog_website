...
class Tags extends Model
{
    ...
    {
        $query = "SELECT * FROM tags JOIN pivot_posts_tags ON tags.id_tag = pivot_posts_tags.tag_id_pivot JOIN posts ON posts.id_posts = pivot_posts_tags.post_id_pivot WHERE pivot_posts_tags.post_id_pivot = posts.id_posts";
