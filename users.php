...
class Users extends Model
{
    ...
    public function register($datas): array|string
    {
        ...
        $nama_file = random_int(1000, 9999) . "." . $ekstensi_file;
        move_uploaded_file($tmp_name, "./../../oop/assets/img/posts/" . $nama_file);
    ...
    {
        $query = "SELECT * FROM posts JOIN categories ON posts.category_id = categories.id_category JOIN users on posts.user_id = users.id_user WHERE users.id_user = '$id' LIMIT 0, 1";
        $result = mysqli_query($this->db, $query);
